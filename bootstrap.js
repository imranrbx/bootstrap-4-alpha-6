$(function() {
    ...
    $('body').one('pinegrow-ready', function(e, pinegrow) {
        var f = new PgFramework('bs4.0', 'Bootstrap 4.0 Alpha');
        f.type = "bootstrap";
        f.allow_single_type = true;

        f.description = '<a href="http://v4-alpha.getbootstrap.com/">Bootstrap 4 Alpha</a> starting pages and components.';
        f.author = 'Pinegrow';
        ...
        f.setScriptFileByScriptTagId('plugin-bootstrap-4.0'); //get url if script is included directly into edit.html
            ...
            'sections' : crsaAddStandardSections({
                ...
                layout_phone : {
                    ...
                    fields : {
                        ...
                        offset_xs : createColumnSpans("Offs", "xs-offset", true, 0),
                        push_xs : createColumnSpans("Push", "xs-push", true, 0),
                        pull_xs : createColumnSpans("Pull", "xs-pull", true, 0),
                        span_sm : createColumnSpans("Span", "col-sm", true),
                        offset_sm : createColumnSpans("Offs", "sm-offset", true, 0),
                        push_sm : createColumnSpans("Push", "sm-push", true, 0),
                        pull_sm : createColumnSpans("Pull", "sm-pull", true, 0),
                        span_md : createColumnSpans("Span", "col-md", true),
                        offset_md : createColumnSpans("Offs", "md-offset", true, 0),
                        push_md : createColumnSpans("Push", "md-push", true, 0),
                        pull_md : createColumnSpans("Pull", "md-pull", true, 0),
                        span_lg : createColumnSpans("Span", "col-lg", true),
                        offset_lg : createColumnSpans("Offs", "lg-offset", true, 0),
                        push_lg : createColumnSpans("Push", "lg-push", true, 0),
                        pull_lg : createColumnSpans("Pull", "lg-pull", true, 0)
                    }
                }
            })
        });
...
795 Folsom Ave, Suite 600<br/>\
    ...
    <tbody>\
        ...
        var restructureForm = function($el, values) {
            ...
            $el.find('label').addClass('form-control-label');
            ...
            if($el.is('.form-inline, .form-inline')) {
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">\
                    ...
                    fields : {
                        'layout' : {
                            ...
                            set_value: function(obj, value, values, oldValue, eventType) {
                                ...
                                var $el = obj.data;
                                var pgel = new pgQuery($el);
                                pgel.removeClass('form-horizontal').removeClass('form-inline').removeClass('form-normal').removeClass('form-inline');
                                pgel.addClass(value);
                                restructureForm($el, values);
                                $.fn.crsa("setNeedsUpdate", false, $el);
                            }
        ...
        <label class="form-control-label" for="' + id + '">Field label</label>\
<input type="text" class="form-control" id="' + id + '" placeholder="Placeholder text">\
       ...
       /*     'selector' : function($el) {
        ...
        var form_checkbox = {
            ...
            'code' : '<label>\
        <input class="form-control-label" type="checkbox" value="">\
        Checkbox label\
        </label>',
            'name' : 'Checkbox',
            'sections' : crsaAddStandardSections({
       ...
       /*     'selector' : function($el) {
        ...
        var form_radio = {
            ...
            'code' : '<label class="form-control-label">\
        <input type="radio" name="group" value="option1" checked>\
        Option one\
        </label>',
            'name' : 'Radio',
        ...
        var form_label = {
            'type' : 'label',
            'selector' : 'label',
            'code' : '<label class="form-control-label">Email address</label>',
            'name' : 'Form label',
            'sections' : crsaAddStandardSections({
                'style' : {
                    name : 'Label options',
    ...
    <input type="text" class="form-control" placeholder="Username">\
        ...
        var button = {
            ...
            'selector' : '.btn',
            'name' : 'Button',
            'code' : '<button type="button" class="btn btn-secondary">Label</button>',
            'content_selector' : null,
            'drag_code' : null, //same as card code
...
<li class="dropdown-divider"></li>\
    <li><a href="#">Separated link</a></li>\
        ...
        var dropdown_classes = [
            ...
            {key: 'dropdown-divider', name: 'dropdown-divider'},
                    ...
                    fields : {
                        type : {
                            ...
                            set_value: function(obj, value, values) {
                                ...
                                var need_a = value != 'dropdown-header' && value != 'dropdown-divider';
    ...
    <li class="active">Data</li>\
        ...
        (function() {
            ...
            var navbar = {
                'type' : 'navbar',
                'selector' : '.navbar',
                'code' : '<nav class="navbar navbar-toggleable-md navbar-light bg-faded">\
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">\
    ...
    <form class="form-inline my-2 my-lg-0">\
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>\
                ...
                tags: 'major',
                'action_menu' : {
                    'add' : ['link', 'navbar-brand', 'form-inline', 'navbar-list', 'navbar-dropdown'],
                    'on_add' : function($el, $new, newdef, prepend) {
                        ...
                        } else if(['form-inline' ,'navbar-list'].indexOf(newdef.type) >= 0) {
                            var $div = findDiv($el, '.navbar-collapse');
                            var pgdiv = new pgQuery($div);
                            if(prepend) {
                                pgdiv.prepend(pgnew);
                ...
                'sections' : crsaAddStandardSections({
                            ...
                            collapse : {
                                ...
                                set_value: function(obj, value, values) {
                                    ...
                                    if(value) {
                                        ...
                                        var $button = $el.find('.navbar-toggler');
                                        var pgbutton = new pgQuery($button);
                                        if($button.length == 0) {
                                            var pgbutton = new pgQuery().create('<button class="navbar-toggler" data-toggle="collapse" data-target="#' + cid + '"></button>');
                    ...
                    <span class="icon-bar"></span>');
                                        ...
                                        var $header = $el.find('.navbar-header');
                                        var $button = $el.find('.navbar-toggler').remove();
                                        var $content = $el.find('.navbar-collapse');
                            ...
                            type : {
                                ...
                                options: [
                                    ...
                                    {key: "sticky-top", name: "Static - top"}
                                ]
                            },
                            inverse : {
                                name : 'Inverse',
            ...
            var form = {
                'type' : 'form-inline',
                'selector' : null,
                'code' : '<form class="form-inline navbar-left" role="search">\
        <div class="form-group row">\
    ...
    <li>Purus sodales ultricies</li>\
        ...
        (function() {
            ...
            f.addComponentType({
                'type' : 'span-label',
                'selector' : 'span.tag',
                'code' : '<span class="tag label-default">New</span>',
                'name' : 'Label',
                'sections' : crsaAddStandardSections({
                    'list' : {
                        name : 'Label',
        ...
        <img src="' + getPlaceholderImage() + '" alt="">\
            <div class="caption">\
                ...
                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>\
                <p><a href="#" class="btn btn-primary" role="button">Button</a> <a href="#" class="btn btn-secondary" role="button">Button</a></p>\
            </div>\
        </div>\
        </div>',
    ...
    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.\
        ...
        f.addComponentType({
            ...
            priority: 100,
            'code' : '<div class="card">\
        <div class="card-block">Basic card example</div>\
    </div>',
            'name' : 'card',
            action_menu: {
                add: ['card-heading', 'card-footer', 'table', 'list-group'],
                on_add : function($el, $new, newdef) {
                    var pgEl = new pgQuery($el);
                    var pgNew = new pgQuery($new);
                    if(newdef.type == 'card-heading') {
                        pgEl.prepend(pgNew);
                        //$el.prepend($new);
                    } else if(newdef.type == 'card-footer') {
                        pgEl.append(pgNew);
                        //$el.append($new);
                    } else if(newdef.type == 'table' || newdef.type == 'list-group') {

                        var $b = $el.find('>.card-body');
                        if($b.length == 0) {
                            pgEl.append(pgNew);
                            //$el.append($new);
                        } else {
                ...
                'card' : {
                    ...
                    fields : {
                        variation : {
                            ...
                            'show_empty' : true,
                            'options' : [
                                {'key' : 'card-primary', 'name' : 'Primary'},
                                {'key' : 'card-success', 'name' : 'Success'},
                                {'key' : 'card-info', 'name' : 'Info'},
                                {'key' : 'card-warning', 'name' : 'Warning'},
                                {'key' : 'card-danger', 'name' : 'Danger'},
                                {'key' : 'card-inverse', 'name' : 'Inverse'},
                            ]
                        }
                    }
                }
        ...
        f.addComponentType({
            'type' : 'card-heading',
            'selector' : 'div.card-heading',
            parent_selector: '.card',
            priority: 100,
            'code' : '<div class="card-heading">card heading without title</div>',
            'name' : 'card heading',
            'sections' : crsaAddStandardSections({
                'style' : {
                    name : 'card heading',
        ...
        f.addComponentType({
            ...
            parent_selector: '.card',
            'code' : '<div class="card-footer">card footer</div>',
            'name' : 'card footer',
            'sections' : crsaAddStandardSections({
            })
        });
...
<li class="dropdown-divider"></li>\
    <li><a href="#">Separated link</a></li>\
        ...
        f.addComponentType({
            ...
            'code' : function() {
                var id1 = getUniqueId('card', null, 0);
        ...
        f.addComponentType({
            ...
            'code' : function() {
                ...
                return '<div class="card-group" id="' + pid + '">\
                    ...
                    <div id="' + id1 + '" class="card-collapse collapse in">\
                    <div class="card-body">\
                    ...
                    <div class="card card-default">\
                        ...
                        <div id="' + id2 + '" class="card-collapse collapse">\
                            <div class="card-body">\
                            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.\
                            </div>\
                        </div>\
                    ...
                    <div class="card card-default">\
                        ...
                        <div id="' + id3 + '" class="card-collapse collapse">\
                            <div class="card-body">\
                            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.\
                            </div>\
                        </div>\
        ...
        f.addComponentType({
            ...
            'code' : function() {
                ...
                return '<div class="card card-default">\
                    ...
                    <div id="' + id1 + '" class="card-collapse collapse">\
                        <div class="card-body">\
                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.\
                    </div>\
                    </div>\
        ...
        section.setComponentTypes( getTypes(['span-label', 'badge', 'alert', 'progress', 'progress-bar', 'media-list', 'media-list-item', 'list-group', 'list-group-item', 'card', 'card-heading', 'card-footer', 'well']));
        f.addLibSection(section);
        ...
        var res = new PgComponentTypeResource('https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/css/bootstrap.min.css');
        res.type = 'text/css';
        f.resources.add(res);
        ...
        res = new PgComponentTypeResource('https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js');
        res.type = 'application/javascript';
        res.footer = true;
        f.resources.add(res);
